...
@Tag(name = "Employees", description = "Core employee records.")
...
public class EmployeeController {
    ...
    @Operation(summary = "List all Employee records")
    @ApiResponses({
    ...
    public EmployeeResponse findById(
            @Parameter(description = "Employee identifier")@PathVariable UUID id) {
