...
/**
 * Strategy for TimeOffRequest processing, dispatched by the {@code status} field.
 *
 ...
 */
public interface TimeOffRequestProcessingStrategy {
    ...
    void execute(TimeOffRequest entity);
}
