...
class EmployeeDocumentRepositoryTest {
    ...
    private EmployeeDocument newEntity(int seed) {
        EmployeeDocument entity = new EmployeeDocument();
        
        entity.setEmployeeId(UUID.randomUUID());
        
        entity.setOriginalFilename("test-security" + seed);
        
        entity.setMimeType("test-security" + seed);
        
        entity.setStoragePath("test-security" + seed);
        
        entity.setSizeBytes((long) (seed + 1));
        return entity;
    }
    ...
    void should_persist_entity_and_assign_id_when_saved() {
        EmployeeDocument saved = repository.save(newEntity(0));
