...
class EmployeeSkillRepositoryTest {
    ...
    private EmployeeSkill newEntity(int seed) {
        EmployeeSkill entity = new EmployeeSkill();
        
        entity.setEmployeeId(UUID.randomUUID());
        
        entity.setSkillName("test-security" + seed);
        
        entity.setProficiencyLevel("beginner");
        return entity;
    }
    ...
    void should_persist_entity_and_assign_id_when_saved() {
        EmployeeSkill saved = repository.save(newEntity(0));
